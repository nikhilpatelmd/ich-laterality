...
f_vas_90_beta <- function(data) {
  ...
  model <- brm(
    bf(
      euro_vas_90_transformed ~ ich_laterality + age + ich_volume_baseline + gcs_baseline + ivh + ich_location,
...
f_vas_180_beta <- function(data) {
  ...
  model <- brm(
    bf(
      euro_vas_180_transformed ~ ich_laterality + age + ich_volume_baseline + gcs_baseline + ivh + ich_location,
...
f_vas_365_beta <- function(data) {
  ...
  model <- brm(
    bf(
      euro_vas_365_transformed ~ ich_laterality + age + ich_volume_baseline + gcs_baseline + ivh + ich_location,
