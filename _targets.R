...
tar_plan(
  ...
  post_pred_check_days_mechanical_ventilation = f_post_predictive_check(m_posterior_neutral_days_mechanical_ventilation),
  ...
  euro_mobility_90_png = ggsave(here("manuscripts", "euro_90_mobility.png"),
    plot = euro_90_mobility_fig, height = 14, width = 20, dpi = 600, bg = "white",
  ),
  euro_90_selfcare_fig = euro_figure_function(ich_aggressive, euro_selfcare_90),
  euro_selfcare_90_png = ggsave(here("manuscripts", "euro_90_selfcare.png"),
    plot = euro_90_selfcare_fig, height = 14, width = 20, dpi = 600, bg = "white",
  ),
  euro_90_usual_fig = euro_figure_function(ich_aggressive, euro_usual_90),
  euro_usual_90_png = ggsave(here("manuscripts", "euro_90_usual.png"),
    plot = euro_90_usual_fig, height = 14, width = 20, dpi = 600, bg = "white",
  ),
  euro_90_pain_fig = euro_figure_function(ich_aggressive, euro_pain_90),
  euro_pain_90_png = ggsave(here("manuscripts", "euro_90_pain.png"),
    plot = euro_90_pain_fig, height = 14, width = 20, dpi = 600, bg = "white",
  ),
  euro_90_anxiety_fig = euro_figure_function(ich_aggressive, euro_anxiety_90),
  euro_anxiety_90_png = ggsave(here("manuscripts", "euro_90_anxiety.png"),
    plot = euro_90_anxiety_fig, height = 14, width = 20, dpi = 600, bg = "white",
  ),
  ...
  euro_vas_90_png = ggsave(here("manuscripts", "euro_90_vas.png"),
