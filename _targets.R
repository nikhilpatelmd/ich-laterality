...
tar_plan(
  ...
  m_prior_mrs_90_canonical = f_prior_mrs_90_canonical(ich_aggressive),
  m_prior_mrs_180_minimal = f_prior_mrs_180_minimal(ich_aggressive),
  m_prior_mrs_180_canonical = f_prior_mrs_180_canonical(ich_aggressive),
  m_prior_mrs_365_minimal = f_prior_mrs_365_minimal(ich_aggressive),
  m_prior_mrs_365_canonical = f_prior_mrs_365_canonical(ich_aggressive),
  m_prior_euro_mobility_90_minimal = f_prior_euro_mobility_90_minimal(ich_aggressive),
  m_prior_euro_mobility_90_canonical = f_prior_euro_mobility_90_canonical(ich_aggressive),
  m_prior_euro_mobility_180_minimal = f_prior_euro_mobility_180_minimal(ich_aggressive),
  m_prior_euro_mobility_180_canonical = f_prior_euro_mobility_180_canonical(ich_aggressive),
  m_prior_euro_mobility_365_minimal = f_prior_euro_mobility_365_minimal(ich_aggressive),
  m_prior_euro_mobility_365_canonical = f_prior_euro_mobility_365_canonical(ich_aggressive),
  m_prior_euro_selfcare_90_minimal = f_prior_euro_selfcare_90_minimal(ich_aggressive),
  m_prior_euro_selfcare_90_canonical = f_prior_euro_selfcare_90_canonical(ich_aggressive),
  m_prior_euro_selfcare_180_minimal = f_prior_euro_selfcare_180_minimal(ich_aggressive),
  m_prior_euro_selfcare_180_canonical = f_prior_euro_selfcare_180_canonical(ich_aggressive),
  m_prior_euro_selfcare_365_minimal = f_prior_euro_selfcare_365_minimal(ich_aggressive),
  m_prior_euro_selfcare_365_canonical = f_prior_euro_selfcare_365_canonical(ich_aggressive),
  m_prior_euro_usual_90_minimal = f_prior_euro_usual_90_minimal(ich_aggressive),
  m_prior_euro_usual_90_canonical = f_prior_euro_usual_90_canonical(ich_aggressive),
  m_prior_euro_usual_180_minimal = f_prior_euro_usual_180_minimal(ich_aggressive),
  m_prior_euro_usual_180_canonical = f_prior_euro_usual_180_canonical(ich_aggressive),
  m_prior_euro_usual_365_minimal = f_prior_euro_usual_365_minimal(ich_aggressive),
  m_prior_euro_usual_365_canonical = f_prior_euro_usual_365_canonical(ich_aggressive),
  m_prior_euro_pain_90_minimal = f_prior_euro_pain_90_minimal(ich_aggressive),
  m_prior_euro_pain_90_canonical = f_prior_euro_pain_90_canonical(ich_aggressive),
  m_prior_euro_pain_180_minimal = f_prior_euro_pain_180_minimal(ich_aggressive),
  m_prior_euro_pain_180_canonical = f_prior_euro_pain_180_canonical(ich_aggressive),
  m_prior_euro_pain_365_minimal = f_prior_euro_pain_365_minimal(ich_aggressive),
  m_prior_euro_pain_365_canonical = f_prior_euro_pain_365_canonical(ich_aggressive),
  m_prior_euro_anxiety_90_minimal = f_prior_euro_anxiety_90_minimal(ich_aggressive),
  m_prior_euro_anxiety_90_canonical = f_prior_euro_anxiety_90_canonical(ich_aggressive),
  m_prior_euro_anxiety_180_minimal = f_prior_euro_anxiety_180_minimal(ich_aggressive),
  m_prior_euro_anxiety_180_canonical = f_prior_euro_anxiety_180_canonical(ich_aggressive),
  ...
  m_posterior_mrs_180_canonical = f_posterior_mrs_180_canonical(ich_aggressive),
  m_posterior_mrs_365_minimal = f_posterior_mrs_365_minimal(ich_aggressive),
  m_posterior_mrs_365_canonical = f_posterior_mrs_365_canonical(ich_aggressive),
  m_posterior_euro_mobility_90_minimal = f_posterior_euro_mobility_90_minimal(ich_aggressive),
  m_posterior_euro_mobility_90_canonical = f_posterior_euro_mobility_90_canonical(ich_aggressive),
  m_posterior_euro_mobility_180_minimal = f_posterior_euro_mobility_180_minimal(ich_aggressive),
  m_posterior_euro_mobility_180_canonical = f_posterior_euro_mobility_180_canonical(ich_aggressive),
  m_posterior_euro_mobility_365_minimal = f_posterior_euro_mobility_365_minimal(ich_aggressive),
  m_posterior_euro_mobility_365_canonical = f_posterior_euro_mobility_365_canonical(ich_aggressive),
  m_posterior_euro_selfcare_90_minimal = f_posterior_euro_selfcare_90_minimal(ich_aggressive),
  m_posterior_euro_selfcare_90_canonical = f_posterior_euro_selfcare_90_canonical(ich_aggressive),
  m_posterior_euro_selfcare_180_minimal = f_posterior_euro_selfcare_180_minimal(ich_aggressive),
  m_posterior_euro_selfcare_180_canonical = f_posterior_euro_selfcare_180_canonical(ich_aggressive),
  m_posterior_euro_selfcare_365_minimal = f_posterior_euro_selfcare_365_minimal(ich_aggressive),
  m_posterior_euro_selfcare_365_canonical = f_posterior_euro_selfcare_365_canonical(ich_aggressive),
  m_posterior_euro_usual_90_minimal = f_posterior_euro_usual_90_minimal(ich_aggressive),
  m_posterior_euro_usual_90_canonical = f_posterior_euro_usual_90_canonical(ich_aggressive),
  m_posterior_euro_usual_180_minimal = f_posterior_euro_usual_180_minimal(ich_aggressive),
  m_posterior_euro_usual_180_canonical = f_posterior_euro_usual_180_canonical(ich_aggressive),
  m_posterior_euro_usual_365_minimal = f_posterior_euro_usual_365_minimal(ich_aggressive),
  m_posterior_euro_usual_365_canonical = f_posterior_euro_usual_365_canonical(ich_aggressive),
  m_posterior_euro_pain_90_minimal = f_posterior_euro_pain_90_minimal(ich_aggressive),
  m_posterior_euro_pain_90_canonical = f_posterior_euro_pain_90_canonical(ich_aggressive),
  m_posterior_euro_pain_180_minimal = f_posterior_euro_pain_180_minimal(ich_aggressive),
  m_posterior_euro_pain_180_canonical = f_posterior_euro_pain_180_canonical(ich_aggressive),
  m_posterior_euro_pain_365_minimal = f_posterior_euro_pain_365_minimal(ich_aggressive),
  m_posterior_euro_pain_365_canonical = f_posterior_euro_pain_365_canonical(ich_aggressive),
  m_posterior_euro_anxiety_90_minimal = f_posterior_euro_anxiety_90_minimal(ich_aggressive),
  m_posterior_euro_anxiety_90_canonical = f_posterior_euro_anxiety_90_canonical(ich_aggressive),
  m_posterior_euro_anxiety_180_minimal = f_posterior_euro_anxiety_180_minimal(ich_aggressive),
  m_posterior_euro_anxiety_180_canonical = f_posterior_euro_anxiety_180_canonical(ich_aggressive),
  m_posterior_euro_anxiety_365_minimal = f_posterior_euro_anxiety_365_minimal(ich_aggressive),
  m_posterior_euro_anxiety_365_canonical = f_posterior_euro_anxiety_365_canonical(ich_aggressive),
