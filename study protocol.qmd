...
mistie2.combined.demographics <- left_join(mistie2.demographics3, mistie2.demographics)
mistie2.combined.demographics <- left_join(mistie2.demographics2, mistie2.combined.demographics)
...
ninds.combined <- ninds.combined %>%
  ...
  mutate(ich.location.baseline = case_when(
    ich.location.baseline == "Basal Ganglia" ~ "Basal Ganglia",
    ich.location.baseline == "Brainstem" ~ "Brainstem",
    ich.location.baseline == "Caudate" ~ "Basal Ganglia",
    ich.location.baseline == "Cerebellum" ~ "Cerebellum",
    ich.location.baseline == "Frontal" ~ "Lobar",
    ich.location.baseline == "Globus Pallidus" ~ "Basal Ganglia",
    ich.location.baseline == "Lobar" ~ "Lobar",
    ich.location.baseline == "Occipital" ~ "Lobar",
    ich.location.baseline == "Other" ~ "Other",
    ich.location.baseline == "Parietal" ~ "Lobar",
    ich.location.baseline == "Primary IVH" ~ "Primary IVH",
    ich.location.baseline == "Probable Primary IVH" ~ "Primary IVH",
    ich.location.baseline == "Putamen" ~ "Basal Ganglia",
    ich.location.baseline == "Temporal" ~ "Lobar",
    ich.location.baseline == "Thalamus" ~ "Thalamus"
