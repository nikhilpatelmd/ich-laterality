...
erich.whole <- erich.whole %>%
  mutate(
    tracheostomy = str_detect(erich.whole$IT5F_SPEC, "TRACH"))

# Variables missing: nihss.baseline, hydrocephalus, phe.volume.cc, sp.shift.baseline, intubation.days, tracheostomy
