...
erich.whole <- erich.whole %>%
  mutate(symptom.onset = case_when(
...
erich.whole <- erich.whole %>%
  mutate(nsgy.evacuation.date = case_when(
...
erich.whole <- erich.whole %>%
  mutate(death.interval = as_date(death.date) - as_date(symptom.onset)) %>%
  as.duration(death.interval)

erich.whole$death.interval <- parse_integer(erich.whole$death.interval)
