...
#### Priors
Two sets of priors were applied for all models, both assuming no association of hemispheric laterality on the outcomes of interest: 1) default vague priors as defined by the 'brms' software package; 2) flat priors; 3) weakly informative priors based on previous literature. A description of the reasons for these priors is available in the supplementary material.
